...
// Função para carregar  um card de endereço, ira receber um objeto(endereco), e um contador, vindo de onde a função estiver sendo invocada;
    ...
    campos.forEach(campo => {
        ...
        if (input.name === 'cep') {
            ...
            input.oninput = (e) => {
                ...
                getEndereco(input.value, id + count);
