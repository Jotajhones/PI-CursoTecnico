...
function preecherForm(id_descricao, id_produto, denominacao, preco, estoque, descricao, url, cor, tecido, categoria, tamanho, destaque, porcentagem, situacao) {
    ...
    document.querySelector('#destaque').value = destaque;
    document.querySelector('#promocao').value = porcentagem;
