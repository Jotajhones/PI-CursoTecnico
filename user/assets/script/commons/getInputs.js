...
function getInputs() {
    ...
    const genero = document.querySelector('#genero'); // É um select, não input
    const telefone = document.querySelector('#telefone');
    const nascimento = document.querySelector('#nascimento');
    const cep = document.querySelector('#cep');
    const rua = document.querySelector('#rua');
    const uf = document.querySelector('#uf'); // É um select, não input
    ...
    const adicionar = document.querySelector('#cadastrar'); 
